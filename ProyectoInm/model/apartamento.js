module.exports = {
    obtener:function(conexion,funcion){
        conexion.query("SELECT N.idNivel, N.nombre, N.altura, N.size, N.precio, N.fotografia, I.nombre as NombreInm, N.estado from nivel N, inmueble I where N.idInmueble = I.idInmueble;", funcion);
    },
